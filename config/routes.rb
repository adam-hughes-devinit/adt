Adt::Application.routes.draw do
  ...
  match '/queries/post_comment', to: 'static_pages#post_comment', as: 'post_comment'
  match '/queries/post_suggestion', to: 'static_pages#post_suggestion', as: 'post_suggestion'
