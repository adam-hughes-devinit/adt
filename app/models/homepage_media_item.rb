class HomepageMediaItem < ActiveRecord::Base
  ...
  def youtube_embed(youtube_url,height,width)
    ...
    %Q{<iframe id="youtube_slide" title="YouTube video player" width="#{ width }" height="#{ height }" src="http://www.youtube.com/embed/#{ youtube_id }?enablejsapi=1" frameborder="0"  allowfullscreen="false"></iframe>}
  end
end
