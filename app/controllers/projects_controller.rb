...
caches_page :show, :cache_path => Proc.new { |c| "#{current_user_is_aiddata}/projects/#{c.params[:id]}"}
caches_page :index, :cache_path => Proc.new { |c| "#{current_user_is_aiddata}/projects/#{c.params.inspect}" }
